...
public class UnitConvertorYards {
    ...
    // Main method for user input and conversion
    public static void main(String[] args) {
        ...
        double inchesToMeters = scanner.nextDouble();
        System.out.println(inchesToMeters + " inches is equal to " + convertInchesToMeters(inchesToMeters) + " meters.");

        System.out.println("Enter the value in inches to convert to centimeters:");
        double inchesToCm = scanner.nextDouble();
        System.out.println(inchesToCm + " inches is equal to " + convertInchesToCm(inchesToCm) + " centimeters.");
